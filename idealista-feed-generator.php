            ...
            switch ($inmueble_data['tipo_inmueble']) {
                ...
                case 'local':
                    $property['propertyFeatures'] = array(
                        ...
                        'featuresAreaConstructed' => intval( $inmueble_data['m_construidos'] ),
                        'featuresFacadeArea' => max(1, intval($inmueble_data['m_lineales']) == 0 ? intval($inmueble_data['m_utiles']) : intval($inmueble_data['m_lineales'])),                        'featuresRooms' => intval( $inmueble_data['num_estancias'] ),
                        'featuresBathroomNumber' => isset($inmueble_data['num_banos']) && !is_null($inmueble_data['num_banos']) && $inmueble_data['num_banos'] > 0 ? intval($inmueble_data['num_banos']) : 1,                        
                ...
                case 'oficina':
                    $property['propertyFeatures'] = array(
                        ...
                        'featuresBathroomNumber' => isset($inmueble_data['num_banos']) && !is_null($inmueble_data['num_banos']) && $inmueble_data['num_banos'] > 0 ? intval($inmueble_data['num_banos']) : 1,                        
                        'featuresAreaUsable' => max(1, intval($inmueble_data['m_parcela']) == 0 ? intval($inmueble_data['m_utiles']) : intval($inmueble_data['m_parcela'])),                        'featuresLiftNumber' => intval( $inmueble_data['num_ascensores'] ),
