...
This plugin generates and sends a properties feed to Idealista.

== Description ==

Idealista Properties Feed is a plugin that generates and sends a properties feed to Idealista. 
...
If you need to customize your synchronization, you can contact me to establish a collaboration.
...
3. Go to 'Settings' > 'Idealista Properties Feed' to configure the plugin.

== Frequently Asked Questions ==

= How do I configure the plugin? =

Once you have activated the plugin, go to 'Settings' > 'Idealista Properties Feed' to configure the plugin.
It is prepared to synchronize custom post types of type "inmueble" generated with the "property" plugin (https://github.com/jjmontalban/inmuebles).

= How do I send the feed to Idealista? =
